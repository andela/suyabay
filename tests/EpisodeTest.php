...
class EpisodeTest extends TestCase
{
    ...
    {
        Episode::create(['episode_name' => 'test', 'episode_description' => 'test', 'channel_id' => 1, 'view_count' => 0, 'image' => 'dummy url', 'audio_mp3' => 'dummy url', 'status' => 0]);

        $this->seeInDatabase('episodes', ['episode_name' => 'test', 'episode_description' => 'test', 'channel_id' => 1, 'view_count' => 0, 'image' => 'dummy url', 'audio_mp3' => 'dummy url', 'status' => 0]);
    }
