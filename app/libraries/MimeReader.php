...
class MimeReader
{
    ...
    */
    ...
    protected function sniff_msoffice()
    {
        ...
        if ($type === 'application/office-x') {
            ...
            if (strpos($sof, "\x5b\x43\x6f\x6e\x74\x65\x6e\x74\x5f\x54\x79\x70\x65\x73\x5d\x2e\x78\x6d\x6c") !== false) {
                ...
                if ($f_pos !== false) {
                    ...
                    if ($s_pos !== false) {
                        ...
                        } elseif (strpos($type, 'xl/') !== false) {
                            $type = 'application/vnd.ms-excel';
                        } elseif (strpos($type, 'x/') !== false) {
        ...
        } elseif ($type === 'application/office') {
            ...
            if (strpos($eof, "\x57\x6F\x72\x64\x2E\x44\x6F\x63\x75\x6D\x65\x6E\x74\x2E") !== false) {
                ...
                // Microsoft Excel
            } elseif (strpos($eof, "\x4D\x69\x63\x72\x6F\x73\x6F\x66\x74\x20\x45\x78\x63\x65\x6C") !== false) {
                $type = 'application/vnd.ms-excel';

                // P.o.w.e.r.P.o.i.n.t. .D.o.c.u.m.e.n.t.
            } elseif (strpos($sof, "\x50\x00\x6F\x00\x77\x00\x65\x00\x72\x00\x50\x00\x6f\x00\x69\x00\x6e\x00\x74\x00\x20\x00\x44\x00\x6f\x00\x63\x00\x75\x00\x6d\x00\x65\x00\x6e\x00\x74\x00") !== false) {
                $type = 'application/vnd.ms-powerpoint';
            } else {
                return false;
            }
