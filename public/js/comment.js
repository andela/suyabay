$(document).ready(function(){
	...
	var comment       = trim($("#comment-field"+divId).val());
			...
			success: function(response) {
				switch (response.status_code)
				{
					case 200:
						...
						$(".load_comment"+divId).last().append('<div id="show_comment" class="collection-item avatar show_comment'+divId +'"><div class="row"><div class="col s2"><img src="'+ avatar +'" alt="" class="circle"></div><div class="col s10"><div class="textarea-wrapper" placeholder="">'+comment+'</div></div></div></div>');
