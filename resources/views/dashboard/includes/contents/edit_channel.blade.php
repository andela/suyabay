            ...
            <form class="col s12">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <input value="Channel title from database" placeholder="Channel Title" id="first_name" type="text" class="validate">
                ...
                <div class="row">
                    <div class="input-field col s12">
                    <input value="Channel title from description" id="disabled" type="text" class="validate">
